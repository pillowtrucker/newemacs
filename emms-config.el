...
(setq emms-stream-bookmarks-file "~/emms/emms-streams")
(setq emms-history-file "~/emms/emms-history")
(setq emms-cache-file "~/emms/emms-cache")
(setq emms-source-file-default-directory "/home/wrath/Music")
...
(setq emms-browser-default-covers '("~/emms/cover_small.jpg"))
