;;; custom.el  --- Unreal Emacs entry point.    -*- lexical-binding: t; -*-
...
(custom-set-variables
 ...
 '(lsp-clients-clangd-args
   '("--header-insertion=iwyu" "--completion-style=detailed"
     "--background-index" "-j=8" "--clang-tidy"
     "--all-scopes-completion" "--cross-file-rename"
     "--header-insertion-decorators" "--rename-file-limit=0"
     "--use-dirty-headers"))
 ...
 '(safe-local-variable-values
   '((smie-indent-basic . 2) (eval racket-add-back-end default-directory)
     ...
     (projectile-project-run-cmd
      . "cargo run -j8 -- --shadow-resolution 16384 --shadow-distance 100")
     ...
     (projectile-project-run-cmd
      . "~/godot-mine/result/bin/godot4 -e --path ~/if_your_happy_and_you_know_it/")
     (projectile-project-compilation-cmd
