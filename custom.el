(custom-set-variables
 ...
 '(lsp-clients-clangd-args
   '("--header-insertion=iwyu" "--completion-style=detailed" "--background-index" "-j=8" "--clang-tidy" "--all-scopes-completion" "--cross-file-rename" "--header-insertion-decorators" "--rename-file-limit=0" "--use-dirty-headers") t)
